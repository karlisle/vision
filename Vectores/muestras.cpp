...
void Muestras::guardar(cv::Mat frame, cv::Mat X0, cv::Mat lEye, cv::Mat rEye, int& nFrame, cv::VideoCapture& capture)
{
	...
	*/
	...
	this->setData(lEye, rEye, p20x, p20y, p21x, p21y, p23x, p23y, p24x, p24y, p26x, p26y, p27x, p27y, p29x, p29y, p30x, p30y, nFrame);
	/*
...
void Muestras::setData(cv::Mat lEye, cv::Mat rEye, int p20x, int p20y, int p21x, int p21y, int p23x, int p23y, int p24x, int p24y, int p26x, int p26y, int p27x, int p27y, int p29x, int p29y, int p30x, int p30y, int nFrame)
{
	...
	*/
	...
	imgPuntos << id << "," << p20x << "," << p20y << "," << p21x << "," << p21y << "," << p23x << "," << p23y << "," << p24x << "," << p24y << "," << p26x << "," << p26y << "," << p27x << "," << p27y << "," << p29x << "," << p29y << "," << p30x << "," << p30y << endl;
	...
	*/
	...
	char sql[999] = " ";
	sprintf(sql, "insert into puntosroi(p20x, p20y, p21x, p21y, p23x, p23y, p24x, p24y, p26x, p26y, p27x, p27y, p29x, p29y, p30x, p30y) values (%d, %d, %d, %d, %d, %d, %d, %d, %d, %d, %d, %d, %d, %d, %d, %d);", p20x, p20y, p21x, p21y, p23x, p23y, p24x, p24y, p26x, p26y, p27x, p27y, p29x, p29y, p30x, p30y);
	cout << sql << endl;
