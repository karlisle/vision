...
\addcontentsline{toc}{chapter}{Introducción}
	...
	todo momento, la cantidad de factores que involucrada en la correcta percepción de los estímulos visuales y su posterior 
	procesamiento e interpretación, son tareas que abordadas desde la perspectiva de un dispositivo electrónico, son extremadamente
	complicadas.\\
	
	La tecnología actual tiene limitaciones al tratar de abordar esta tare, hay en el campo de la
	...
	Posteriormente en la época renacentista y grandes pintores, \textit{Filippo Bruneleschi} \texttt{(1377-1446) }por ejemplo, 
	...
	El proyecto en si es ambicioso de primeras, pues actualmente pese a que la tecnología de asistencia para magnificar áreas de la
	...
	Se abordara el problema usando las herramientas de la ingeniería de software, las técnicas y herramientas se presentaran 
	en los diferentes capítulos del presente documento, así como los resultados de las investigaciones y procesos para llevar a 
	buen término la tarea expuesta.
...
\section{Herramientas de desarrollo}
	...
	\subsection{Sublime-Text \label{subl}}
		...
		\begin{multicols}{2}
			\begin{itemize}
				 \item Minimapa. consiste en una pre-visualización de la estructura del código
	...
	\subsection{Sistema de control de versiones Git \label{git}}
		Git es un software de control de versiones diseñado por \gls{Linus}, pensando en la eficiencia y la confiabilidad del
	...
	\subsection{MariaDB \label{maria}}
		\textsc{MariaDB} es un sistema de gestión de bases de datos derivado de \textsc{MySQL} con licencia \textsc{\gls{GPL}}.
	...
	\subsection{SQLite}
		\textsc{SQLite} es un sistema de gestión de bases de datos relacional compatible con \textsc{\gls{ACID}}, contenida en una
...
\section{Diseño}
	...
	\subsection{Aproximación clásica \label{clasica}}
		...
		\begin{figure}[t]
		 	...
		 	\subfigure[CNN]{\includegraphics[width=69mm]{./Diagramas/cnn.pdf} \label{f_lenet}}
...
\section{Desarrollo}
	...
	\subsection{Captura de vídeo y detección de rostros}
		...
		\begin{figure}[hbt]
			\centering
				%\subfigure[Marcadores faciales]{\includegraphics[width=60mm]{./intraface/face19.png} \label{i_face}
				\subfigure[Marcadores faciales]{\includegraphics[width=40mm]{/intraface/face19.png} \label{i_face}} \hspace{3cm}
				\subfigure[\'Angulos de Euler]{\includegraphics[width=40mm]{/euler.png} \label{i_aEuler}}
	...
	\subsection{Clasificador de parpadeo} 
		...
		\begin{figure}[t]
			\centering
			\subfigure[Ojos abiertos.]{\includegraphics[width=40mm]{/intraface/face10_crop.png} \label{i_faceEyeOpen}}
			\subfigure[Ojos cerrado. ]{\includegraphics[width=40mm]{/intraface/face25_crop.png} \label{i_faceEyeClose}}
